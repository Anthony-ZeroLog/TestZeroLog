...
<h2 class="categories__title">Notes</h2>
        ...
        <div class="categories__posts--flex">
            ...
            <div class="categories__posts--right">
                ...
                <div class="categories__posts--data">
                    <div class="cstegories__posts--categories">
                        {% for category in post.categories %}
                            <a class="categories__categories--element" href="/category/{{ category | slugify }}">{{ category }}</a>
                        {% endfor %}
                    </div>
